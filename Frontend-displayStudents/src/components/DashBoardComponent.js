                ...
                <Table striped bordered hover variant="dark" responsive="sm">
                    ...
                    {this.props.studentList.map((student, index) =>
                      <tr key={student._id} >
                        ...
                        <td>{student.name}</td>
                        <td>{student.email}</td>
                        <td>{student.address.gata}</td>
                        <td>{student.address.postnummer}</td>
                        <td>{student.address.ort}</td>
                        <td><Button variant="danger" className="removeBtn" onClick={(e) => this.removstudentName(student._id, e)} >x</Button></td>
                      </tr>
                    )}
                    </tbody>
                 </Table>
